...
const overlayControlSchemas = {
  ...
  TeamPreview: {
    labels: { '--detail-color-1': 'SPECIAL HIGHLIGHT TEXT', '--bg-dark': 'CARD GRADIENT – DARK', '--bg-light': 'CARD GRADIENT – LIGHT', '--bg-mid': 'CARD GRADIENT – CENTER', '--red-main': 'TOP / UNDERLINE ACCENT', '--red-bright': 'UNDERLINE BRIGHT COLOR', '--red-deep': 'DEEP ACCENT', '--white': 'LEGACY GENERAL TEXT', '--text-soft': 'LEGACY SOFT TEXT', '--panel-border': 'CARD BORDER', '--it-logo-bg': 'LOGO BACKGROUND', '--it-title': 'MAIN TITLE TEXT', '--it-team': 'TEAM NAME TEXT', '--it-player': 'PLAYER NAME TEXT', '--it-error': 'ERROR / NO DATA TEXT' },
    sections: [['background', 'CARD BACKGROUND', ['--bg-light', '--bg-mid', '--bg-dark', '--panel-border', '--it-logo-bg']], ['text', 'TEXT', ['--it-title', '--it-team', '--it-player', '--it-error', '--detail-color-1']], ['accent', 'ACCENTS', ['--red-main', '--red-bright', '--red-deep']], ['legacy', 'LEGACY COLORS', ['--white', '--text-soft']]], open: ['background', 'text']
  },
  TopAliveStatus: {
